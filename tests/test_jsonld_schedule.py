...
class JsonLdScheduleTests(unittest.TestCase):
    ...
    def test_jsonld_event_image_survives_the_canonical_public_contract(self):
        payload = {
            "@context": "https://schema.org",
            "@type": "Event",
            ...
            "image": {
                "@type": "ImageObject",
                "contentUrl": "https://images.example.test/events/concert.webp",
                "url": "https://images.example.test/events/thumbnail.webp",
            },
        }
        html = f'<script type="application/ld+json">{json.dumps(payload)}</script>'
        ...
        self.assertEqual(event["image_url"], "https://images.example.test/events/concert.webp")
        self.assertEqual(canonical.image_url, "https://images.example.test/events/concert.webp")
        self.assertEqual(canonical.to_dict()["image_url"], "https://images.example.test/events/concert.webp")
