...
def runtime_config(days_ahead: int | None = None) -> RuntimeConfig:
    ...
    return RuntimeConfig(
        ...
        source_timeout_seconds=_float("NRW_EVENTS_SOURCE_TIMEOUT_SECONDS", 180.0, 5.0, 1800.0),
        source_baseline_min_count=_int("NRW_EVENTS_SOURCE_BASELINE_MIN_COUNT", 10, 1, 10_000),
        json_out=os.environ.get("NRW_EVENTS_JSON_OUT", str(default_state_dir() / "nrw-events-latest.json")),
...
VENUE_COORDS = {
    ...
    "bendorf": (50.4306, 7.5717),
    "mülheim-kärlich": (50.3869, 7.4953),
    "meckenheim": (50.6314, 7.0289),
    "rheinbach": (50.6255, 6.9499),
    "hennef": (50.7752, 7.2836),
    "lohmar": (50.8377, 7.2136),
    "frechen": (50.9103, 6.8140),
    "erftstadt": (50.8148, 6.7939),
    "hürth": (50.8790, 6.8760),
    "huerth": (50.8790, 6.8760),
    "zülpich": (50.6939, 6.6533),
    "zuelpich": (50.6939, 6.6533),
    "rösrath": (50.8955, 7.1836),
    "roesrath": (50.8955, 7.1836),
    "bergisch gladbach": (50.9923, 7.1286),
    "bergneustadt": (51.0240, 7.6546),
    "gummersbach": (51.0267, 7.5647),
    "nümbrecht": (50.9047, 7.5402),
    "waldbröl": (50.8758, 7.6169),
    "wiehl": (50.9490, 7.5332),
    "reichshof": (50.9562, 7.6963),
    "denklingen": (50.9164, 7.6511),
    "much": (50.9025, 7.4021),
    "eitorf": (50.7696, 7.4524),
    "brühl": (50.8282, 6.9063),
    "bruehl": (50.8282, 6.9063),
    "wesseling": (50.8271, 6.9747),
    "neunkirchen-seelscheid": (50.8648, 7.3364),
    "grafschaft": (50.5728, 7.0876),
    "bad münstereifel": (50.5568, 6.7646),
    "bad muenstereifel": (50.5568, 6.7646),
    "euskirchen": (50.6606, 6.7872),
    "ruppichteroth": (50.8436, 7.4847),
    "windeck": (50.7978, 7.5726),
    "herchen": (50.7836, 7.5160),
    "rosbach": (50.8039, 7.6087),
    "wissen": (50.7792, 7.7342),
    "steinebach/sieg": (50.7390, 7.8152),
    "steinebach": (50.7390, 7.8152),
    "wachtberg": (50.6262, 7.1167),
    "alfter": (50.7339, 7.0011),
    "swisttal": (50.6300, 6.8870),
    "niederkassel": (50.8136, 7.0386),
    # Bonn districts
    "poppelsdorf": (50.7267, 7.0863),
    "endenich": (50.7272, 7.0650),
    "beuel": (50.7390, 7.1170),
    "bad godesberg": (50.6830, 7.1500),
    "bonn-beuel": (50.7390, 7.1170),
    "bonn-bad godesberg": (50.6830, 7.1500),
    "bonn-duisdorf": (50.7150, 7.0420),
    "bonn-oberkassel": (50.7158, 7.1667),
    "bonn-pützchen": (50.7470, 7.1630),
    "bonn-roleber": (50.7330, 7.1860),
    "bonn-holzlar": (50.7420, 7.1750),
    "bonn-vilich": (50.7550, 7.1230),
    "bonn-vilich-müldorf": (50.7520, 7.1570),
    "ippendorf": (50.7065, 7.0780),
    "dransdorf": (50.7355, 7.0508),
    "plittersdorf": (50.7018, 7.1435),
    "bonn-plittersdorf": (50.7018, 7.1435),
    "oberkassel": (50.7158, 7.1667),
    "oberdollendorf": (50.6990, 7.1850),
    "venusberg": (50.7047, 7.0968),
    "lannesdorf": (50.6606, 7.1556),
    "rheinaue": (50.7106, 7.1283),
    "freizeitpark rheinaue": (50.7106, 7.1283),
    ...
    "rheinbreitbach": (50.6166, 7.2320),
    "bruchhausen": (50.6020, 7.2533),
    ...
    "monheim": (51.0916, 6.8925),
    "monheim am rhein": (51.0916, 6.8925),
    "leichlingen": (51.1061, 7.0187),
}
