...
class RuntimeConfig:
    ...
    ai_source_timeout_grace_seconds: float = 14400.0
...
def runtime_config(days_ahead: Optional[int] = None) -> RuntimeConfig:
    ...
    return RuntimeConfig(
        ...
        ai_source_timeout_grace_seconds=_float(
            "NRW_EVENTS_AI_SOURCE_TIMEOUT_GRACE_SECONDS", 14400.0, 0.0, 21600.0
        ),
...
VENUE_COORDS = {
    ...
    "frechen": (50.9103, 6.8140), "erftstadt": (50.8148, 6.7939),
    "hürth": (50.8790, 6.8760), "huerth": (50.8790, 6.8760),
    "zülpich": (50.6939, 6.6533), "zuelpich": (50.6939, 6.6533),
    "rösrath": (50.8955, 7.1836), "roesrath": (50.8955, 7.1836),
    "bergisch gladbach": (50.9923, 7.1286), "bergneustadt": (51.0240, 7.6546),
    "gummersbach": (51.0267, 7.5647), "nümbrecht": (50.9047, 7.5402),
    "waldbröl": (50.8758, 7.6169), "wiehl": (50.9490, 7.5332),
    "reichshof": (50.9562, 7.6963), "denklingen": (50.9164, 7.6511),
