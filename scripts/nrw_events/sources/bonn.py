...
from .bonn_sports import (
    _enrich_sport_details as _enrich_sport_details,
)
from .bonn_sports import (
    _parse_sport_time as _parse_sport_time,
)
from .bonn_sports import (
    events_from_sport_teasers as events_from_sport_teasers,
)
from .bonn_sports import (
    fetch_sports as fetch_sports,
)
