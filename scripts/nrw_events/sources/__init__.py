...
from . import (
    ...
    hoffloh_bonn, okken, geide, krewelshof, melan, rheinbach_flohmarkt,
    bonner_weihnachtsmarkt, katharinenhof,
...
CUSTOM_SOURCES = {
    ...
    "Krewelshof Kindersachen-Flohmarkt": krewelshof.fetch,
    "Melan Märkte": melan.fetch,
    "Rheinbach Flohmarkt": rheinbach_flohmarkt.fetch,
