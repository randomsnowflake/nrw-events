...
VENUE_REGISTRY: tuple[VenueRecord, ...] = (
    ...
    _venue("st-josef-beuel", "St. Josef Beuel", "St Josef", "St. Josef", "Sankt Josef", "Pfarrkirche St. Josef", "Pfarrkirche St. Joseph", city="Bonn", district="Bonn-Beuel", venue_type="church", address="Hermannstraße 35, 53225 Bonn", coordinates=(50.7369187, 7.1177258)),
    ...
    _venue("museum-august-macke-haus", "Museum August Macke Haus", "August Macke Haus", "August-Macke-Haus", city="Bonn", district="Bonn-Nordstadt", venue_type="museum", address="Hochstadenring 36, 53119 Bonn", coordinates=(50.7374719, 7.0863201)),
    _venue("rhein-sieg-forum", "RHEIN SIEG FORUM", city="Siegburg", venue_type="event_venue"),
    _venue("siegburg-marktplatz", "Marktplatz Siegburg", "Marktplatz", "Siegburger Marktplatz", "Denkmal am Markt", city="Siegburg", venue_type="public_space", address="Markt, 53721 Siegburg", coordinates=(50.79706, 7.20717)),
    _venue("burg-wissem", "Burg Wissem", city="Troisdorf", venue_type="civic_structure", address="Burgallee 1, 53840 Troisdorf", coordinates=(50.8174198, 7.1655246)),
    _venue("stadtgarten-alter-zoll-bonn", "Stadtgarten am Alten Zoll", "Bühne im Stadtgarten am Alten Zoll", "Stadtgarten Alter Zoll", "Alter Zoll", "Alten Zoll", "Bonner Stadtbefestigung", city="Bonn", district="Bonn-Zentrum", venue_type="park", address="Adenauerallee, 53113 Bonn", coordinates=(50.7345375, 7.1078957)),
    _venue("schloss-augustusburg-bruehl", "Schloss Augustusburg", "Schloss Augustusburg - UNESCO-Welterbe", "Treff Kassenraum Schloss Augustusburg", "Kassenraum Schloss Augustusburg", city="Brühl", venue_type="civic_structure", address="Parkplatz Max-Ernst-Allee, 50321 Brühl", coordinates=(50.8284022, 6.9077385)),
    _venue("pferderennbahn-parkplatz-koeln", "Pferderennbahn-Parkplatz Köln", "Pferderennbahn Parkplatz", "Pferderennbahn-Parkplatz", "Köln Pferderennbahn Parkplatz", "Parkplatz Galopprennbahn Weidenpesch", city="Köln", district="Weidenpesch", venue_type="market", address="Scheibenstraße 40, 50737 Köln", coordinates=(50.9844437, 6.9512376)),
    _venue("troedelscheune-waldbroel", "Trödelscheune Waldbröl", "Trödelscheune", "Trödelscheune Waldbröl-Hermesdorf", city="Waldbröl", district="Hermesdorf", venue_type="market", address="Hauptstraße 92, 51545 Waldbröl", coordinates=(50.8963377, 7.6572297)),
