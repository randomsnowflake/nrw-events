...
VENUE_REGISTRY: tuple[VenueRecord, ...] = (
    ...
    _venue("stadtgarten-alter-zoll-bonn", "Stadtgarten am Alten Zoll", "Bühne im Stadtgarten am Alten Zoll", "Stadtgarten Alter Zoll", "Alter Zoll", "Alten Zoll", city="Bonn", district="Bonn-Zentrum", venue_type="park", address="Adenauerallee, 53113 Bonn", coordinates=(50.7345375, 7.1078957)),
