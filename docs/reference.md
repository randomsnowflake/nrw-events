...
| `NRW_EVENTS_GATED_DETAIL_CACHE_TTL_HOURS` | `72` | Mindest-TTL gecachter Detailseiten von kdvz-Portalen (bonn.de, SiteKit-Kommunen), unabhängig vom Cache-Namespace. Datum, Zeit und Wegfall kommen aus der täglichen Liste; Detailseiten reichern nur an. |
