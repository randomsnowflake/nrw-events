...
| `NRW_EVENTS_GATED_DETAIL_CACHE_TTL_HOURS` | `72` | Mindest-TTL der Detailseiten-Caches `bonn-detail`, `bonn-sports-detail` und `regional-sitekit-detail`. Datum, Zeit und Wegfall kommen aus der täglichen Liste; Detailseiten reichern nur an. |
